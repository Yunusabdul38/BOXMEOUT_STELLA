...
export class MarketsController {
    ...
    async createMarket(req: AuthenticatedRequest, res: Response): Promise<void> {
        try {
            ...
            const resolutionTime = data.resolutionTime ? new Date(data.resolutionTime) : undefined;
     ...
     */
    async getMarketDetails(req: AuthenticatedRequest, res: Response): Promise<void> {
        try {
